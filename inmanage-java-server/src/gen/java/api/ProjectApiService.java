...
public abstract class ProjectApiService {
    ...
    public abstract Response deleteProject(String projectId,String passWord,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getSpecificTask(String projectID,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getUserAmount(String projectId,SecurityContext securityContext) throws NotFoundException;
}
